...
There are two classes of platform user, known as __Basic__ and __User__, click to read more about [Hornbill Platform User Accounts](/esp-fundamentals/security/user-accounts).  While both types are user accounts on the platform, the __Basic__ user account does not require a subscription, but has very limited access to the platforms capabilities. The primary reason for the __Basic__ user account is to provide end users (our customr's internal users) access to the Employee Portal, which is free-to-use for your entire organization and is where your end-users who are being served/supported by your Hornbill users would get access to the services and knowledge and other information you have provided to them via self-service/chatbot interfaces. The employee portal enables basic or full users to browse and subscribe to services they are allowed, raise requests for themselves, seek help or self-serve help and/or access knowledge/documentation.  __Basic__ user accounts do not have access to any function, capability or data that is considered usable by people who are using Hornbill to participate in the provision of service to other employees or customers.   
...
>Certain areas of Hornbill that are normally subject to a subscription charge are enabled for use, for free, for all customers, but has some form of inherent restrictions and/or limits baked in, in the absence of a subscription.  It is often asked if those limits can be increased or changed in some way. The answer generally is no, because, we decided what we felt was reasonable at the time of introduction in accordance with our [Subscription Model In Principle](/esp-fundamentals/in-the-cloud/subscription-model#subscription-model-in-principle) and baked those limits into the code. So while we cannot change these, we are always open to consider requests for such changes to the product that will not undermine our ability to exchange reasonable value on a commercial basis, but we reserve the right to refuse such requests also.  However, it should be noted that if there is a need to evaluate beyond what the free tier limits are, it is possible for customers to engage with us directly and request a fully functional, short term evaluations (typically 14 calendar days) of almost every available app or module that Hornbill provides. If this is the case, then please contact our customer success team to discuss your requirements and request an evaluation and they can work with you to understand your needs and arrange the evaluation period for you. 

#### Whats the "Spirit" of Hornbill's Subscription Model when it comes to Concurrent Users, Limited Use, or Infrequent Users?
>Hornbill’s subscription model is built on a straightforward principle: If you are actively participating in the delivery or provision of services using the Hornbill platform, you require a subscription. Individuals whose roles involve contributing to or managing the delivery of services through the Hornbill platform need a subscription. This includes subscriptions for each specific application they use within the platform. Individuals who are merely recipients of the services delivered through Hornbill do not require a subscription. For example, customers or end-users accessing self-service portals or other areas tailored to them as service recipients can do so without needing a subscription.

#### I have a number of users who very infrequently need to use Hornbill and/or Hornbill Apps, why do they need a full subscription?
>The Hornbill subscription model does not differentiate between frequent and infrequent users. A significant part of the value provided by Hornbill and its applications lies in the system’s functionality, even when users are not actively logged in. While you may not be using the system frequently, Hornbill continues to work for you in the background. Tasks such as managing queued work, sending notifications to your mobile device, maintaining your profile, and ensuring your membership in groups and teams is accessible for assignments, approvals, and request management are handled seamlessly. This infrastructure ensures your work and information are effectively managed at all times.  As someone actively participating in the delivery of services to others, you require a subscription regardless of the frequency of your usage.

#### Using your API's and Automation Capabilities, Can I roll-by-own Subscription Sharing or Infrequent User Scheme to save on subscription fees?
> No, this is not allowed. Hornbill’s subscription model is designed to ensure fair and consistent access to its platform and applications for all users actively participating in the delivery of services. Creating custom schemes to share subscriptions or circumvent the need for individual subscriptions undermines the integrity of this model and violates Hornbill’s terms of use. Automation capabilities and APIs are provided to enhance operational efficiency, not to bypass licensing requirements. Each user participating in the delivery of services through the Hornbill platform requires their own subscription, regardless of usage frequency. Attempting to implement a subscription-sharing scheme disrupts the principles on which the platform is built and can lead to account suspension or other penalties. Hornbill’s pricing structure reflects the continuous value provided by the platform, even when users are not actively logged in. This value includes managing queued work, maintaining user profiles, enabling seamless collaboration, information sharing, and supporting automation processes. Ensuring every active participant has a proper subscription is critical to maintaining fairness and sustainability for all customers. 

...
> If you do either of these things you will be asked to use the forum to post your request.  I would refer to the section [Work With Us](/esp-fundamentals/about/about-roadmap#things-you-can-do-to-improve-the-chances-of-getting-your-feature-request-included) above.  Because of the complexity involved in translating individual customer requirements into product function in such a complex system as Hornbill, its unreasonable to expect a Hornbill Account Manager or Customer Support Exec to act as a '''man-in-the-middle''' in the requirements gathering/understanding process.  We intentionally do not have ANY internal systems that allows someone to "Log a Feature Request", instead we require all feature requests to originate from a documented and resolved conversation, which in almost all cases means, a meaningful and documented discussion that leads to confirmation from Hornbill's product team that we have a clear and definitive understanding of what is being asked for.  We follow this process for both internal changes and customer-originated requests/suggestions, using our internal workspaces and community forums respectively.  This is our process, and the only process we follow for customer-requested product enhancement requests. 